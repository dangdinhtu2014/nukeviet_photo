  ...
  <table class="table table-striped table-bordered table-hover">
    ...
    <thead>
      <tr>
        ...
        <td class="text-center">Dự án mẫu</td>
    ...
    <tbody>
      <tr>
		...
		<td style="text-align: center">
			<input type="checkbox" name="type" id="change_type_{DATA.albumid}" value="{DATA.albumid}" {DATA.checked1} onclick="nv_chang_type({DATA.albumid});"/>
		</td>
	...
	<tr class="tfoot_box">
		...
		<td colspan="6" class="text-center"><!-- BEGIN: generate_page -->{GENERATE_PAGE}<!-- END: generate_page --></td>
	</tr>
	</tbody>
